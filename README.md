...
Each are a little dated and have some buggy or unintitive behaviour for me so I would like to improve on that.
Afterwards I hope to add my own unique features, if I find the time.

## My Changes
- Added "//" Command to support comments in script files
...
#### History Navigation
- Arrow key up/down for previous commands auto complete/cycling
- Arrow key right for auto complete until next space/argument
